...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function ensureHeaderPresent() {
        try {
            ...
            if (hasHeader && hasUser && hasDaltonico) {
                // Re-sincronizar estado del botón y nombre por si cambió el dataset.page o el perfil
            ...
            // Render rápido desde caché si existe y es válido
    ...
    // Hook SPA: cuando el router detecta restore/swap, pedir revalidación del header
