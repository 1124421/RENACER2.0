...
function renacerInitModalesAsociados() {
    ...
    cargarTodosLosModales().then(() => {
        ...
        if (typeof flatpickr !== 'undefined') {
            ...
            // Inicializar flatpickr solo en el campo de edición (el de nuevo es solo lectura)
            const fechaInicioEdit = document.getElementById('editFechaInicio');
            
            // Establecer fecha actual en el campo de nuevo asociado
            ...
            if (fechaInicioNuevo) {
                ...
                fechaInicioNuevo.value = `${dia}/${mes}/${año}`;
            }
            
            if (fechaInicioEdit) flatpickr(fechaInicioEdit, fpConfig);
        }
